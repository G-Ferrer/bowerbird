...
def comprobacion_carpetas_y_archivos():
    ...
    if not os.path.exists(ruta_principal + '/src/imprimir_lista_cartas.py'):
        ...
        raw_input(" Pulse enter para salir...")
        raise SystemExit
    if not os.path.exists(ruta_principal + '/src/fuerza_bruta_thread_top.c'):
        print ' No se encuentra %s/src/fuerza_bruta_thread_top.c\n' % ruta_principal
        raw_input(" Pulse enter para salir...")
        raise SystemExit
    if not os.path.exists(ruta_principal + '/src/fuerza_bruta_thread_top'):
        print ' No se encuentra %s/src/fuerza_bruta_thread_top\n' % ruta_principal
        print ' Compilar con gcc fuerza_bruta_thread_top.c -o fuerza_bruta_thread_top\n'
        raw_input(" Pulse enter para salir...")
        raise SystemExit
    if not os.path.exists(ruta_principal + '/src/fuerza_bruta_thread_bottom.c'):
        print ' No se encuentra %s/src/fuerza_bruta_thread_bottom.c\n' % ruta_principal
        raw_input(" Pulse enter para salir...")
        raise SystemExit
    if not os.path.exists(ruta_principal + '/src/fuerza_bruta_thread_bottom'):
        print ' No se encuentra %s/src/fuerza_bruta_thread_bottom\n' % ruta_principal
        print ' Compilar con gcc fuerza_bruta_thread_bottom.c -o fuerza_bruta_thread_bottom\n'
        raw_input(" Pulse enter para salir...")
        raise SystemExit
    if not os.path.exists(ruta_principal + '/src/fuerza_bruta_matriz_adyacencia_csv_paralelo.c'):
        print ' No se encuentra %s/src/fuerza_bruta_matriz_adyacencia_csv_paralelo.c\n' % ruta_principal
        raw_input(" Pulse enter para salir...")
        raise SystemExit
    if not os.path.exists(ruta_principal + '/src/fuerza_bruta_matriz_adyacencia_csv_paralelo'):
        print ' No se encuentra %s/src/fuerza_bruta_matriz_adyacencia_csv_paralelo\n' % ruta_principal
        print ' Compilar con gcc fuerza_bruta_matriz_adyacencia_csv_paralelo.c -o fuerza_bruta_matriz_adyacencia_csv_paralelo -fopenmp\n'
        raw_input(" Pulse enter para salir...")
        raise SystemExit
